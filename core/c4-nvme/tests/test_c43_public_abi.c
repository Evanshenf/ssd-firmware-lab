...
ABI_SIZE(struct fwlab_c43_command_observer, 200);
...
ABI_FIELD(struct fwlab_c43_command_observer, action_outcome, 96);
ABI_FIELD(struct fwlab_c43_command_observer, block_terminal_kind, 100);
ABI_FIELD(struct fwlab_c43_command_observer, target_ticket, 104);
ABI_FIELD(struct fwlab_c43_command_observer, target_reference, 160);
ABI_FIELD(struct fwlab_c43_command_observer, incoming_target_pins, 176);
ABI_FIELD(struct fwlab_c43_command_observer, target_pin_present, 178);
ABI_FIELD(struct fwlab_c43_command_observer, reserved_action_flags, 179);
ABI_FIELD(struct fwlab_c43_command_observer, reserved_action, 180);

ABI_SIZE(struct fwlab_c43_graph_observer, 984);
...
ABI_FIELD(struct fwlab_c43_graph_observer, reserved_ready_credits, 872);
ABI_FIELD(struct fwlab_c43_graph_observer, reserved_lease_credits, 876);
ABI_FIELD(struct fwlab_c43_graph_observer, reserved_consume_credits, 880);
ABI_FIELD(struct fwlab_c43_graph_observer, reserved_finalizer_credits, 884);
ABI_FIELD(struct fwlab_c43_graph_observer, reserved_abort_credits, 888);
ABI_FIELD(struct fwlab_c43_graph_observer, reserved_target_credits, 892);
ABI_FIELD(struct fwlab_c43_graph_observer,
          reserved_queue_transaction_credits, 896);
ABI_FIELD(struct fwlab_c43_graph_observer, reserved_block_intent_credits, 900);
ABI_FIELD(struct fwlab_c43_graph_observer, nq_state, 904);
ABI_FIELD(struct fwlab_c43_graph_observer, queue_owner_slot_plus_one, 908);
ABI_FIELD(struct fwlab_c43_graph_observer, queue_txn_active, 910);
ABI_FIELD(struct fwlab_c43_graph_observer, io_cq_present, 911);
ABI_FIELD(struct fwlab_c43_graph_observer, io_sq_present, 912);
ABI_FIELD(struct fwlab_c43_graph_observer, reserved_queue_flags, 913);
ABI_FIELD(struct fwlab_c43_graph_observer, io_cq, 920);
ABI_FIELD(struct fwlab_c43_graph_observer, io_sq, 936);
ABI_FIELD(struct fwlab_c43_graph_observer, sq_associated_cq, 952);
ABI_FIELD(struct fwlab_c43_graph_observer, reserved_queue, 968);

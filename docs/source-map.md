...
| Historical 64-GiB qualification entry | `headless-scale/ftl.mk check-64g` / `--full-64g` | Selects C3 NFC/compact-media-v1; not a PAGE2/physical-v2 large-capacity test. The latter unified route is separate future work |

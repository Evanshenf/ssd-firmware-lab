...
| Optional native per-runtime workers | Same entries plus `--nand-workers 1\|4`; [native_worker.c](../frontends/linux-m4/native_worker.c), [nfc_channel_workers.c](../frontends/headless-scale/nfc_channel_workers.c) | Native-private retained lifetime/short waits, polling startup and actual joins; no FTL/NFC actor rewrite; [ADR-0026](adr/0026-native-worker-lifetime.md) and [software evidence](results/2026-09-14-native-worker-lifetime.md), not threaded kernel/M5 qualification |

...
| Native channel opt-in | [native_scaled_media.c](../frontends/linux-m4/native_scaled_media.c), [test_scaled_runtime.c](../frontends/linux-m4/tests/test_scaled_runtime.c), existing `mq2-worker` / `progress-runtime` with `--nand-profile channel-lab4k` | Same worker constructor/loop and mutable format3/IPR, process-lived volume and fresh runtimes; [bounded actual x86-64 L1](results/2026-09-14-native-channel-l1.md) follows fake-Host checks, no new M5/threaded proof; [ADR-0025](adr/0025-native-channel-construction.md) |
| Optional native per-runtime workers | Same entries plus `--nand-workers 1\|4`; [native_worker.c](../frontends/linux-m4/native_worker.c), [nfc_channel_workers.c](../frontends/headless-scale/nfc_channel_workers.c) | Native-private lifetime/waits, actual joins; no FTL/NFC actor rewrite; [ADR-0026](adr/0026-native-worker-lifetime.md), [software1/4](results/2026-09-14-native-worker-lifetime.md), [native x86-64 workers4](results/2026-09-14-native-four-worker-l1.md) and [native ARM64 256MiB workers4](results/2026-09-22-native-arm-channel-256.md); M5/NUMA/performance separate |
| Shared capacity construction | `scale_storage_profile_capacity_mib()` and the exact R0 wrapper in [scale_storage.c](../frontends/headless-scale/scale_storage.c) | R0 and channel profiles select64/256/65536MiB geometry/LBAs together; recovered FTL volume still owns advertised capacity; [ADR-0027](adr/0027-channel-capacity-presets.md) |
| Channel capacity fixture | Existing `native_progress_offline --capacity-plan`,64MiB cooperative and256MiB fourworker arguments | [Actual x86-64/ARM64 software checks](results/2026-09-15-channel-capacity.md); simulated Host, real FTL3/NFC/shards.64GiB sizing only, not native-device qualification |
| Native channel64GiB data episode | Same MQ2 worker with `--namespace-mib 65536 --nand-profile channel-lab4k --nand-workers 4`, existing large client and fio oracle | [Actual ARM64 full-volume write/read, overwrite/GC and cold-recovered readback](results/2026-09-22-native-arm-channel-64g.md); not the sizing fixture, new filesystem matrix, M5 or throughput qualification |

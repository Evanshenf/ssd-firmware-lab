...
lab_module_path=${3:-$kernel_module_dir/ssd_fwlab_dma_lab.ko}
iommu_module_name=ssd_fwlab_sw_iommu_poc
pci_module_name=ssd_fwlab_synth_pci_poc
lab_module_name=ssd_fwlab_dma_lab
lab_driver_name=ssd_fwlab_dma_lab
iommu_loaded=0
pci_loaded=0
lab_loaded=0
bdf=
...
echo "M4-B software-IOMMU/DMA admission: PASS"

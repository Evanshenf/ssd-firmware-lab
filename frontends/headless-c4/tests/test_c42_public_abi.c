...
ABI_OFFSET(struct c42_counter_seed, next, 0);
ABI_OFFSET(struct c42_counter_seed, maximum, 8);
ABI_SIZE(struct c42_config, 232);
ABI_OFFSET(struct c42_config, version, 0);
ABI_OFFSET(struct c42_config, size, 2);
ABI_OFFSET(struct c42_config, maximum_queue_depth, 4);
ABI_OFFSET(struct c42_config, command_capacity, 6);
ABI_OFFSET(struct c42_config, target_capacity, 8);
ABI_OFFSET(struct c42_config, worst_case_actions, 10);
ABI_OFFSET(struct c42_config, safety_generation, 12);
ABI_OFFSET(struct c42_config, instance_nonce, 16);
ABI_OFFSET(struct c42_config, owner_epoch, 24);
ABI_OFFSET(struct c42_config, origin_domain_nonce, 32);
ABI_OFFSET(struct c42_config, origin_uid, 40);
ABI_OFFSET(struct c42_config, client_uid, 56);
ABI_OFFSET(struct c42_config, release_uid, 72);
ABI_OFFSET(struct c42_config, trace_uid, 88);
ABI_OFFSET(struct c42_config, publication_uid, 104);
ABI_OFFSET(struct c42_config, notification_uid, 120);
ABI_OFFSET(struct c42_config, candidate_uid, 136);
ABI_OFFSET(struct c42_config, target_uid, 152);
ABI_OFFSET(struct c42_config, control_uid, 168);
ABI_OFFSET(struct c42_config, reset_uid, 184);
ABI_OFFSET(struct c42_config, teardown_uid, 200);
ABI_OFFSET(struct c42_config, initial_controller_epoch, 216);
ABI_OFFSET(struct c42_config, initial_active_generation, 220);
ABI_OFFSET(struct c42_config, reserved, 224);
ABI_SIZE(struct c42_providers, 32);
ABI_OFFSET(struct c42_providers, memory, 0);
ABI_OFFSET(struct c42_providers, command, 16);
ABI_SIZE(struct c42_operation_token, 24);
ABI_OFFSET(struct c42_operation_token, instance_nonce, 0);
ABI_OFFSET(struct c42_operation_token, uid, 8);
ABI_OFFSET(struct c42_operation_token, generation, 16);
ABI_OFFSET(struct c42_operation_token, kind, 20);
ABI_OFFSET(struct c42_operation_token, reserved, 22);
ABI_SIZE(struct c42_queue_descriptor, 80);
ABI_OFFSET(struct c42_queue_descriptor, version, 0);
ABI_OFFSET(struct c42_queue_descriptor, size, 2);
ABI_OFFSET(struct c42_queue_descriptor, queue_id, 4);
ABI_OFFSET(struct c42_queue_descriptor, associated_cq_id, 6);
ABI_OFFSET(struct c42_queue_descriptor, depth, 8);
ABI_OFFSET(struct c42_queue_descriptor, kind, 10);
ABI_OFFSET(struct c42_queue_descriptor, queue_class, 11);
ABI_OFFSET(struct c42_queue_descriptor, reserved0, 12);
...
ABI_OFFSET(struct c42_candidate_status, token, 0);
ABI_OFFSET(struct c42_candidate_status, state, 24);
ABI_OFFSET(struct c42_candidate_status, cause, 28);
ABI_OFFSET(struct c42_candidate_status, retry, 32);
ABI_OFFSET(struct c42_candidate_status, reserved, 36);
ABI_SIZE(struct c42_control_status, 48);
ABI_OFFSET(struct c42_control_status, token, 0);
ABI_OFFSET(struct c42_control_status, state, 24);
ABI_OFFSET(struct c42_control_status, cause, 28);
ABI_OFFSET(struct c42_control_status, retry, 32);
ABI_OFFSET(struct c42_control_status, reserved, 36);
ABI_SIZE(struct c42_sq_tail_event, 24);
ABI_OFFSET(struct c42_sq_tail_event, instance_nonce, 0);
ABI_OFFSET(struct c42_sq_tail_event, controller_epoch, 8);
ABI_OFFSET(struct c42_sq_tail_event, ring_generation, 12);
ABI_OFFSET(struct c42_sq_tail_event, queue_id, 16);
ABI_OFFSET(struct c42_sq_tail_event, new_tail, 18);
ABI_OFFSET(struct c42_sq_tail_event, reserved, 20);
ABI_SIZE(struct c42_cq_head_event, 24);
ABI_OFFSET(struct c42_cq_head_event, instance_nonce, 0);
ABI_OFFSET(struct c42_cq_head_event, controller_epoch, 8);
ABI_OFFSET(struct c42_cq_head_event, ring_generation, 12);
ABI_OFFSET(struct c42_cq_head_event, queue_id, 16);
ABI_OFFSET(struct c42_cq_head_event, new_head, 18);
ABI_OFFSET(struct c42_cq_head_event, reserved, 20);
ABI_SIZE(struct c42_target_ref, 120);
ABI_OFFSET(struct c42_target_ref, token, 0);
ABI_OFFSET(struct c42_target_ref, handle, 24);
ABI_OFFSET(struct c42_target_ref, origin, 48);
ABI_OFFSET(struct c42_target_ref, ticket, 64);
ABI_SIZE(struct c42_notification, 48);
ABI_OFFSET(struct c42_notification, token, 0);
ABI_OFFSET(struct c42_notification, publication_uid, 24);
ABI_OFFSET(struct c42_notification, cq_ring_generation, 32);
ABI_OFFSET(struct c42_notification, completion_queue_id, 36);
ABI_OFFSET(struct c42_notification, slot_ordinal, 38);
ABI_OFFSET(struct c42_notification, state, 40);
ABI_OFFSET(struct c42_notification, reserved, 44);
ABI_SIZE(struct c42_step_result, 16);
ABI_OFFSET(struct c42_step_result, requested_budget, 0);
ABI_OFFSET(struct c42_step_result, units_executed, 4);
ABI_OFFSET(struct c42_step_result, transitions, 8);
ABI_OFFSET(struct c42_step_result, notifications_ready, 12);
ABI_SIZE(struct c42_queue_snapshot, 24);
ABI_OFFSET(struct c42_queue_snapshot, ring_generation, 0);
ABI_OFFSET(struct c42_queue_snapshot, mapping_generation, 4);
ABI_OFFSET(struct c42_queue_snapshot, queue_id, 8);
ABI_OFFSET(struct c42_queue_snapshot, depth, 10);
ABI_OFFSET(struct c42_queue_snapshot, host_index, 12);
ABI_OFFSET(struct c42_queue_snapshot, device_index, 14);
ABI_OFFSET(struct c42_queue_snapshot, pending_or_unacked, 16);
ABI_OFFSET(struct c42_queue_snapshot, kind, 18);
ABI_OFFSET(struct c42_queue_snapshot, life, 19);
ABI_OFFSET(struct c42_queue_snapshot, phase, 20);
ABI_OFFSET(struct c42_queue_snapshot, reserved, 21);
ABI_SIZE(struct c42_snapshot, 176);
ABI_OFFSET(struct c42_snapshot, version, 0);
ABI_OFFSET(struct c42_snapshot, size, 2);
ABI_OFFSET(struct c42_snapshot, controller_epoch, 4);
ABI_OFFSET(struct c42_snapshot, instance_nonce, 8);
ABI_OFFSET(struct c42_snapshot, owner_epoch, 16);
ABI_OFFSET(struct c42_snapshot, phase, 24);
ABI_OFFSET(struct c42_snapshot, fault_cause, 28);
ABI_OFFSET(struct c42_snapshot, active_commands, 32);
ABI_OFFSET(struct c42_snapshot, target_refs, 36);
ABI_OFFSET(struct c42_snapshot, pending_publications, 40);
ABI_OFFSET(struct c42_snapshot, pending_notifications, 44);
...
ABI_OFFSET(struct c42_queue_memory_cap, instance_nonce, 0);
ABI_OFFSET(struct c42_queue_memory_cap, owner_epoch, 8);
ABI_OFFSET(struct c42_queue_memory_cap, memory_uid, 16);
ABI_OFFSET(struct c42_queue_memory_cap, controller_epoch, 24);
ABI_OFFSET(struct c42_queue_memory_cap, ring_generation, 28);
ABI_OFFSET(struct c42_queue_memory_cap, mapping_generation, 32);
ABI_OFFSET(struct c42_queue_memory_cap, exact_bytes, 36);
ABI_OFFSET(struct c42_queue_memory_cap, queue_id, 40);
ABI_OFFSET(struct c42_queue_memory_cap, role, 42);
ABI_OFFSET(struct c42_queue_memory_cap, reserved, 43);
ABI_SIZE(struct c42_memory_token, 24);
ABI_OFFSET(struct c42_memory_token, instance_nonce, 0);
ABI_OFFSET(struct c42_memory_token, uid, 8);
ABI_OFFSET(struct c42_memory_token, generation, 16);
ABI_OFFSET(struct c42_memory_token, kind, 20);
ABI_OFFSET(struct c42_memory_token, reserved, 22);
ABI_SIZE(struct c42_memory_status, 40);
ABI_OFFSET(struct c42_memory_status, token, 0);
ABI_OFFSET(struct c42_memory_status, result, 24);
ABI_OFFSET(struct c42_memory_status, prefix, 28);
ABI_OFFSET(struct c42_memory_status, committed, 32);
ABI_OFFSET(struct c42_memory_status, quiescent, 33);
ABI_OFFSET(struct c42_memory_status, reserved, 34);
ABI_SIZE(struct c42_memory_ops, 128);
ABI_OFFSET(struct c42_memory_ops, version, 0);
ABI_OFFSET(struct c42_memory_ops, size, 2);
ABI_OFFSET(struct c42_memory_ops, reserved, 4);
ABI_OFFSET(struct c42_memory_ops, validate, 8);
ABI_OFFSET(struct c42_memory_ops, capture, 16);
ABI_OFFSET(struct c42_memory_ops, scrub_start, 24);
ABI_OFFSET(struct c42_memory_ops, scrub_query, 32);
ABI_OFFSET(struct c42_memory_ops, scrub_abort, 40);
ABI_OFFSET(struct c42_memory_ops, scrub_retire_start, 48);
ABI_OFFSET(struct c42_memory_ops, scrub_retire_query, 56);
ABI_OFFSET(struct c42_memory_ops, body_start, 64);
ABI_OFFSET(struct c42_memory_ops, body_query, 72);
ABI_OFFSET(struct c42_memory_ops, marker_start, 80);
ABI_OFFSET(struct c42_memory_ops, marker_query, 88);
ABI_OFFSET(struct c42_memory_ops, reset_begin, 96);
ABI_OFFSET(struct c42_memory_ops, reset_quiescent, 104);
ABI_OFFSET(struct c42_memory_ops, teardown_begin, 112);
ABI_OFFSET(struct c42_memory_ops, teardown_quiescent, 120);
ABI_SIZE(struct c42_memory_port, 16);
ABI_OFFSET(struct c42_memory_port, ops, 0);
ABI_OFFSET(struct c42_memory_port, context, 8);
...
int main(void)
{
    puts("C4.2 public ABI: PASS values=saturated layouts=all-public-offsets");
    return 0;
}

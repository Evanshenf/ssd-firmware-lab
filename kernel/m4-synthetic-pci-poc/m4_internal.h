...
#define FWLAB_M4_PCI_NAME "ssd_fwlab_synth_pci_poc"
#define FWLAB_M4_IOMMU_NAME "ssd_fwlab_sw_iommu_poc"
...
#define FWLAB_M4_BAR_DEFAULT_START 0x70000000ULL
#define FWLAB_M4_BAR_SIZE SZ_16M
...
struct fwlab_m4_pci_ctx {
	...
	u32 bar_epoch;
	struct fwlab_m4_frontend_binding frontend;

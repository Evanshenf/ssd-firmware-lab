...
/* Synthetic PCI endpoint half of the split-lifetime M4 IOMMU PoC. */
...
static int __init fwlab_m4_pci_init(void)
{
	...
	pr_info(FWLAB_M4_PCI_NAME
		": ready bdf=%s group=%d rid=%#x official-vfio-pci eligible\n",
...
MODULE_DESCRIPTION("SSD FWLab synthetic PCI endpoint PoC");

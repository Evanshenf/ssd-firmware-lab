...
"""Build and byte-compare C3.5b S/M/B/P projections on three 64-bit ABIs."""
...
def main() -> int:
    try:
        ...
        print(f"C3.5b cross ABI: FAIL: {error}", file=sys.stderr)
        return 1
    print("C3.5b cross ABI: PASS (native/aarch64/riscv64/s390x; "

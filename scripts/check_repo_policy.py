...
# Cycle 01 and C2.1-C2.5 are retired from the current checkout.
# Their original freeze policy remains in v0.1.0-spine-preview.1.
# See docs/legacy-experiments.md; remaining active freezes are unchanged.
